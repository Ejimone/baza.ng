...
export const qtyControl = {
  ...
  buttonSmall: "w-[26px] h-[26px] bg-transparent items-center justify-center border",
...
export const splash = {
  ...
  greeting: "mt-12 text-xs text-[#2a4a2a] font-mono tracking-wide-lg",
};
...
export const intentGate = {
  ...
  title: "text-[28px] text-txt-primary font-serif tracking-tight-half leading-tight",
  list: "flex-1 px-5 flex-col gap-2.5 pb-6",
  modeButton: "bg-[#0d1a0f] border border-[#1a2a1c] p-[18px] px-5 flex-row items-center gap-4",
...
export const intentGateBalance = {
  ...
  balanceAmount: "text-[24px] text-txt-primary font-bold font-serif tracking-tight-half",
  ...
  avatarButton: "w-10 h-10 rounded-full bg-[#0d1a0f] border border-[#2a4a2c] items-center justify-center text-lg",
  greeting: "px-6 pt-4 pb-4",
  greetingTime: "text-3xs tracking-wide-lg text-[#2a4a2a] mb-1.5",
  greetingTitle: "text-[26px] text-txt-primary font-serif tracking-tight-half leading-tight",
  scrollBody: "flex-1 px-5",
  orderCard: "w-full bg-gradient-to-br from-[#1a1000] to-[#1a0e00] border border-[#f5a62355] p-[14px] px-4 flex-row items-center gap-3.5 mb-3",
  orderIcon: "w-9 h-9 rounded-full bg-[#f5a62320] border border-[#f5a62344] items-center justify-center text-base shrink-0",
  orderLabel: "text-3xs text-baza-amber tracking-wide-xl mb-1",
  orderTitle: "text-[13px] text-txt-primary font-serif tracking-tight-2xs",
  orderEta: "text-3xs text-[#8a6030] mt-[3px] tracking-wide-sm",
  ...
  modeButton: "bg-[#0d1a0f] border border-[#1a2a1c] py-4 px-5 flex-row items-center gap-4",
  modeIcon: "w-[42px] h-[42px] items-center justify-center text-lg",
  modeTitle: "text-sm text-txt-primary font-serif tracking-tight-xs",
  modeDesc: "text-3xs text-[#2a4a2a] tracking-wide-md mt-[3px]",
  modeChevron: "text-base opacity-40",
  stickyCart: "absolute bottom-5 left-5 right-5 bg-txt-primary p-[15px] px-5 flex-row items-center justify-between z-50",
  stickyCartIcon: "text-base",
  stickyCartTitle: "text-[11px] text-black font-mono font-bold tracking-wide-sm",
  stickyCartSub: "text-3xs text-[#555] font-mono mt-0.5 tracking-wide-sm",
  stickyCartCheckout: "text-[11px] font-mono font-bold text-black tracking-wide-md",
  topUpSheet: "absolute inset-0 z-[400] bg-black/85 flex-col justify-end",
  topUpSheetInner: "bg-[#080f09] border-t border-[#1a2a1c] rounded-t-sheet pt-6 px-6 pb-12",
  ...
  topUpConfirmBtn: "w-full py-[15px] font-mono text-[11px] tracking-wide-2xl font-bold mb-2.5",
  topUpCancelBtn: "w-full py-3 bg-transparent text-[#2a3a2a] text-xxs tracking-wide-lg font-mono",
};
...
export const bundleDetail = {
  ...
  backButton: "bg-transparent text-[11px] tracking-wide-lg mb-3.5 p-0 opacity-70",
  ...
  retailRow: "flex-row justify-between mb-1 text-3xs text-[#2a3a2a] tracking-wide-lg",
  ...
  addToCartBtn: "w-full py-[15px] font-mono text-[11px] tracking-wide-2xl font-bold",
};
...
export const stockUpMode = {
  ...
  backButton: "bg-transparent text-[11px] text-[#3a5c3a] tracking-wide-lg mb-3 p-0",
...
export const mealPackDetail = {
  ...
  heroEmoji: "text-[72px]",
  heroBackBtn: "absolute top-[52px] left-5 bg-black/50 border border-[#333] text-[#aaa] text-xxs tracking-wide-lg py-[7px] px-3.5",
  infoSection: "px-[22px] pt-4",
  cookTime: "text-3xs tracking-wide-2xl mb-[5px]",
  packTitle: "text-[24px] text-txt-primary font-serif tracking-tight-half mb-[5px]",
  ...
  multiplierValue: "min-w-[18px] text-center text-[11px] text-txt-primary font-mono leading-6",
  ...
  addBtn: "w-full py-[15px] text-black text-[11px] tracking-wide-2xl font-mono font-bold",
};
...
export const tonightMode = {
  ...
  backButton: "bg-transparent text-[11px] text-[#7a8a4a] tracking-wide-lg mb-3 p-0",
  title: "text-[26px] text-txt-primary font-serif tracking-tight-half",
...
export const readyEatMode = {
  ...
  backButton: "bg-transparent text-[11px] text-[#7a3a1a] tracking-wide-lg mb-3 p-0",
  title: "text-[26px] text-txt-primary font-serif tracking-tight-half",
  ...
  addBtn: "py-2 px-4 bg-transparent text-xxs tracking-wide-lg font-mono shrink-0",
  ...
  popupCloseBtn: "absolute top-4 right-5 bg-black/50 w-8 h-8 rounded-full items-center justify-center",
  ...
  popupPlatesBox: "flex-row items-center justify-between mb-[18px] p-3 px-4 bg-[#ffffff0a]",
  ...
  popupPlatesValue: "min-w-[40px] text-center text-base text-txt-primary font-mono leading-9",
  ...
  popupAddBtn: "w-full py-[15px] text-black text-[11px] tracking-wide-2xl font-mono font-bold",
};
...
export const snacksDrinksMode = {
  ...
  backButton: "bg-transparent text-[11px] text-[#6a3a9a] tracking-wide-lg mb-3 p-0",
  title: "text-[26px] text-txt-primary font-serif tracking-tight-half",
  ...
  stepperValue: "min-w-[22px] text-center text-xs text-txt-primary bg-[#0c0714] leading-[26px]",
  stepperInc: "w-[26px] h-[26px] bg-[#1a0a2a] items-center justify-center text-sm",
};
...
export const restockMode = {
  ...
  backButton: "bg-transparent text-[11px] text-[#3a5a8a] tracking-wide-lg mb-3 p-0",
  title: "text-[26px] text-txt-primary font-serif tracking-tight-half mb-3.5",
  searchBox: "bg-[#0d1220] border border-[#1a2540] flex-row items-center py-[11px] px-4 gap-2.5",
  ...
  itemThumb: "w-11 h-11 shrink-0 bg-[#0d1220] items-center justify-center text-xl",
  ...
  addBtn: "py-[7px] px-[18px] bg-transparent border border-[#6ec6ff55] text-baza-blue text-xxs tracking-wide-lg font-mono",
  ...
  stepperValue: "min-w-7 text-center text-[13px] text-txt-primary font-mono bg-[#0d1220] px-1 leading-[30px]",
  stepperInc: "w-8 h-[30px] bg-[#0d1a2a] items-center justify-center text-base text-baza-blue",
};
...
export const chatMode = {
  ...
  header: "pt-status px-5 pb-3.5 border-b border-[#0f1220] flex-row items-center gap-3",
  backButton: "bg-transparent text-[11px] text-baza-orange p-0",
  avatar: "w-[34px] h-[34px] bg-[#ff704322] border border-[#ff704333] rounded-full items-center justify-center text-base",
  ...
  messageBubbleUser: "max-w-[78%] p-2.5 px-3.5 bg-[#ff704322] border border-[#ff704333] text-xs text-[#d0d8e0] leading-relaxed",
  messageBubbleBot: "max-w-[78%] p-2.5 px-3.5 bg-[#0d1220] border border-[#1a2540] text-xs text-[#d0d8e0] leading-relaxed",
  typingIndicator: "flex-row gap-1 p-2.5 px-3.5 bg-[#0d1220] border border-[#1a2540] w-14",
  typingDot: "w-[5px] h-[5px] bg-[#3a5a8a] rounded-full",
  quickReplies: "py-2 px-4 flex-row gap-2",
  quickReplyBtn: "py-[7px] px-3.5 bg-transparent border border-[#1a2a40] text-baza-blue text-xxs tracking-wide-sm",
  inputBar: "py-2.5 px-4 pb-9 flex-row gap-2.5 border-t border-[#0f1220]",
  input: "flex-1 bg-[#0d1220] border border-[#1a2540] py-[11px] px-3.5 text-[#c8d8f0] text-xs font-mono",
...
export const fundPrompt = {
  ...
  sheet: "bg-[#080f09] border-t border-[#1a2a1c] rounded-t-sheet pt-7 px-6 pb-12 font-mono",
  ...
  acctCopyBtn: "bg-transparent border border-[#1a2a1c] text-baza-green text-3xs tracking-wide-lg py-1.5 px-3",
  ...
  confirmBtn: "w-full py-[15px] mb-3 text-[11px] tracking-wide-2xl font-mono font-bold",
  confirmBtnActive: "bg-baza-green text-black",
  confirmBtnInactive: "bg-[#1a2a1c] text-[#2a3a2a]",
  cancelBtn: "w-full py-3 bg-transparent text-[#2a3a2a] text-xxs tracking-wide-lg font-mono",
};
...
export const cartScreen = {
  ...
  topUpBtn: "py-[7px] px-3.5 bg-transparent border border-[#e85c3a55] text-baza-red text-3xs tracking-wide-lg",
  list: "flex-1 px-6 pt-3",
  emptyText: "text-[#1a2a1a] text-[11px] tracking-wide-lg text-center pt-[60px]",
  ...
  confirmBackBtn: "mt-8 py-3 px-7 bg-transparent border border-[#1a2a1c] text-baza-green text-xxs tracking-wide-lg font-mono",
  ...
  subtotalRow: "flex-row justify-between mb-[5px] text-3xs text-[#2a3a2a] tracking-wide-lg",
  subtotalValue: "text-txt-primary",
  deliveryRow: "flex-row justify-between mb-4 text-3xs text-[#2a3a2a] tracking-wide-lg",
  deliveryValue: "text-baza-green",
  noteSection: "mb-3.5",
  noteLabel: "text-2xs text-[#2a3a2a] tracking-wide-lg mb-1.5",
  noteOptional: "text-[#1a2a1a]",
  noteInput: "w-full bg-[#0a120a] border border-[#1a2a1c] py-[11px] px-3.5 text-[#c0d8c0] text-[11px] font-mono leading-relaxed",
...
export const ordersScreen = {
  ...
  emptyText: "text-[#1a2a1a] text-[11px] tracking-wide-lg text-center pt-[60px] leading-loose",
  ...
  orderNote: "mt-2 p-2 px-2.5 bg-[#050a06] border border-[#0f1a10] text-xxs text-[#3a5c3a] leading-relaxed tracking-wide-xs",
...
export const profileScreen = {
  ...
  backButton: "bg-transparent text-[11px] text-[#3a5c3a] tracking-wide-lg mb-4 p-0",
  avatarRow: "flex-row items-center gap-4",
  avatar: "w-[52px] h-[52px] rounded-full bg-[#0d1a0f] border-2 border-[#4caf7d44] items-center justify-center text-[22px]",
  ...
  walletCard: "bg-gradient-to-br from-[#0d1a0f] to-[#0a1a12] border border-[#2a4a2c] p-[22px] mb-4",
  walletLabel: "text-3xs text-[#3a5c3a] tracking-wide-2xl mb-3",
  walletBalance: "text-[36px] text-txt-primary font-bold font-serif tracking-tight-half mb-1",
  walletAvailable: "text-3xs text-[#2a4a2a] tracking-wide-md mb-5",
  walletTopUpBtn: "py-[11px] px-6 bg-baza-green text-black text-xxs tracking-wide-xl font-mono font-bold",
  ...
  acctCopyBtn: "py-2 px-3.5 bg-transparent border border-[#1a2a1c] text-[#3a5c3a] text-3xs tracking-wide-lg font-mono",
  acctCopyBtnActive: "bg-[#4caf7d18] border-[#4caf7d55] text-baza-green",
  navRow: "w-full py-[18px] px-4 bg-[#080f09] border border-[#1a2a1c] flex-row items-center justify-between mb-2.5",
  navRowIcon: "text-lg",
  ...
  settingsLabel: "text-3xs text-[#1a2a1a] tracking-wide-xl mt-2 mb-2.5 pt-4 border-t border-[#0f1a10]",
  settingsRow: "w-full py-4 px-4 bg-[#080f09] border border-[#1a2a1c] flex-row items-center justify-between mb-2",
  ...
  signOutBtn: "w-full py-4 bg-transparent border border-[#2a1a1a] text-[#5a3a3a] text-xxs tracking-wide-xl font-mono mt-1",
  topUpSheet: "absolute inset-0 z-[400] bg-black/85 flex-col justify-end",
  topUpSheetInner: "bg-[#080f09] border-t border-[#1a2a1c] rounded-t-sheet pt-6 px-6 pb-12",
  topUpHandle: "w-9 h-1 bg-[#1a2a1c] rounded-sm mx-auto mb-5",
  topUpLabel: "text-3xs text-[#2a4a2a] tracking-wide-2xl mb-1.5",
...
export const notificationsScreen = {
  ...
  backButton: "bg-transparent text-[11px] text-[#3a5c3a] tracking-wide-lg mb-3.5 p-0",
  title: "text-[26px] text-txt-primary font-serif tracking-tight-half",
  subtitle: "text-3xs text-[#2a4a2a] tracking-wide-lg mt-1",
...
export const deliveryAddressScreen = {
  ...
  backButton: "bg-transparent text-[11px] text-[#3a5a7a] tracking-wide-lg mb-3.5 p-0",
  title: "text-[26px] text-txt-primary font-serif tracking-tight-half",
  ...
  defaultBadge: "text-2xs text-baza-blue tracking-wide-lg py-[3px] px-2 border border-[#6ec6ff33]",
  setDefaultBtn: "text-2xs text-[#3a5a7a] tracking-wide-lg py-[3px] px-2 border border-[#1a2540] bg-transparent",
  addressText: "text-[11px] text-[#8aa0c0] leading-relaxed",
  addressLandmark: "text-3xs text-[#2a4060] mt-1 tracking-wide-sm",
  addNewBtn: "w-full py-[15px] bg-transparent border border-dashed border-[#1a2540] text-[#3a5a7a] text-xxs tracking-wide-xl font-mono",
  formOverlay: "absolute inset-0 z-[400] bg-black/85 flex-col justify-end",
  formSheet: "bg-[#080c10] border-t border-[#1a2540] rounded-t-sheet pt-6 px-6 pb-12",
  ...
  formInput: "w-full bg-[#0d1520] border border-[#1a2540] py-[11px] px-3.5 text-[#c8d8f0] text-xs font-mono mb-3",
  formSaveBtn: "w-full py-3.5 bg-baza-blue text-black text-xxs tracking-wide-2xl font-mono font-bold mt-2 mb-2.5",
  formCancelBtn: "w-full py-3 bg-transparent text-[#2a4060] text-xxs tracking-wide-lg font-mono",
};
...
export const referScreen = {
  ...
  backButton: "bg-transparent text-[11px] text-[#7a7a3a] tracking-wide-lg mb-3.5 p-0",
  title: "text-[26px] text-txt-primary font-serif tracking-tight-half",
  ...
  inviteInput: "flex-1 bg-[#0f0f08] border border-[#2a2a14] py-[11px] px-3.5 text-[#d0d0b0] text-xs font-mono",
  inviteSendBtn: "py-[11px] px-[18px] bg-baza-amber text-black text-[11px] font-bold font-mono",
  sentLabel: "text-3xs text-[#3a3a1a] tracking-wide-xl mb-2.5",
  sentRow: "text-[11px] text-[#5a5a3a] py-2.5 border-b border-[#1a1a0a] flex-row items-center gap-2.5",
  sentCheck: "text-xs text-baza-green",
  sentStatus: "text-3xs text-[#3a3a1a] tracking-wide-sm ml-auto",
  disclaimer: "mt-6 text-xxs text-[#2a2a14] leading-loose tracking-wide-xs border-t border-[#1a1a0a] pt-4",
};
...
export const authScreen = {
  // Welcome
  welcomeContainer: "flex-1 bg-[#060d07] flex-col items-center justify-center font-mono px-8",
  welcomeTagline: "text-3xs tracking-wide-3xl text-[#2a4a2a] mb-7",
  welcomeLogo: "text-[64px] font-black text-txt-primary font-serif tracking-tight-1 leading-none",
  ...
  welcomeCreateBtn: "w-full py-4 bg-baza-green text-black text-[11px] tracking-wide-2xl font-mono font-bold mb-3",
  welcomeSignInBtn: "w-full py-3.5 bg-transparent border border-[#1a2a1c] text-[#3a5c3a] text-xxs tracking-wide-xl font-mono",
  welcomeTerms: "mt-8 text-3xs text-[#1a2a1a] text-center leading-loose tracking-wide-sm",

  // Sign Up
  signupContainer: "flex-1 bg-[#060d07] flex-col font-mono",
  signupHeader: "pt-[60px] px-6 pb-8",
  signupBack: "bg-transparent text-[11px] text-[#3a5c3a] tracking-wide-lg mb-5 p-0",
  ...
  signupInput: "w-full bg-[#0d1a0f] border border-[#1a2a1c] py-3.5 px-4 text-txt-primary text-sm font-mono mb-4",
  signupRefLabel: "text-2xs text-[#2a4a2a] tracking-wide-xl mb-2",
  signupRefOptional: "text-[#1a2a1a]",
  signupRefRow: "flex-row gap-2",
  signupRefInput: "flex-1 bg-[#0d1a0f] border border-[#1a2a1c] py-3 px-3.5 text-txt-primary text-[13px] font-mono tracking-wide-sm",
  ...
  signupSubmitBtn: "w-full py-4 text-[11px] tracking-wide-2xl font-mono font-bold",
  ...
  signinBack: "bg-transparent text-[11px] text-[#3a5c3a] tracking-wide-lg mb-5 p-0",
  ...
  signinInput: "w-full bg-[#0d1a0f] border border-[#1a2a1c] py-3.5 px-4 text-txt-primary text-sm font-mono mb-7",
  signinSubmitBtn: "w-full py-4 text-[11px] tracking-wide-2xl font-mono font-bold",
  ...
  signinSwitchLink: "bg-transparent text-baza-green text-3xs tracking-wide-sm p-0",

  // OTP
  otpContainer: "flex-1 bg-[#060d07] flex-col font-mono",
  otpHeader: "pt-[60px] px-6 pb-8",
  otpBack: "bg-transparent text-[11px] text-[#3a5c3a] tracking-wide-lg mb-5 p-0",
  ...
  otpBox: "w-[46px] h-14 text-center bg-[#0d1a0f] text-txt-primary text-[22px] font-mono",
  ...
  otpVerifyBtn: "w-full py-4 bg-[#1a2a1c] text-[#2a3a2a] text-[11px] tracking-wide-2xl font-mono font-bold",
  otpResendBtn: "mt-5 bg-transparent text-[#2a4a2a] text-3xs tracking-wide-md p-0 text-center",
};
...
export const supportChatScreen = {
  ...
  avatarBox: "relative",
  avatar: "w-9 h-9 rounded-full bg-[#0d1a2a] border border-[#1a2a4a] items-center justify-center text-base",
  humanDot: "absolute bottom-0 right-0 w-3 h-3 rounded-full bg-baza-green border-2 border-[#07090f]",
  headerName: "text-[13px] text-txt-primary",
  ...
  flaggedBadge: "text-2xs text-baza-amber tracking-wide-md py-1 px-2 border border-[#f5a62333] bg-[#f5a62308]",
  ...
  msgBubbleUser: "max-w-[80%] p-2.5 px-3.5 bg-[#ff704318] border border-[#ff704333] text-xs text-[#d0d8e0] leading-relaxed",
  msgBubbleAI: "max-w-[80%] p-2.5 px-3.5 bg-[#0d1a0f] border border-[#1a2a1c] text-xs text-[#d0d8e0] leading-relaxed",
  msgBubbleHuman: "max-w-[80%] p-2.5 px-3.5 bg-[#0d1220] border border-[#2a4a8a44] text-xs text-[#d0d8e0] leading-relaxed",
  flaggedLabel: "text-2xs text-baza-amber mt-1 tracking-wide-md",
  typingIndicator: "flex-row gap-1 p-2.5 px-3.5 bg-[#0d1a0f] border border-[#1a2a1c] w-[52px]",
  typingDot: "w-[5px] h-[5px] bg-[#3a5a3a] rounded-full",
  quickReplies: "py-2 px-4 flex-row gap-2",
  quickReplyBtn: "py-[7px] px-3.5 bg-transparent border border-[#1a2a3a] text-[#3a5a7a] text-3xs tracking-wide-sm",
  inputBar: "py-2.5 px-4 pb-9 flex-row gap-2.5 border-t border-[#0f1220]",
  input: "flex-1 bg-[#0d1220] border border-[#1a2540] py-[11px] px-3.5 text-[#c8d8f0] text-xs font-mono",
  sendBtn: "py-[11px] px-4 bg-[#3a5a8a] text-white text-sm",
  resolvedBar: "py-4 px-6 pb-9 text-center text-xxs text-[#3a5c3a] tracking-wide-lg",
};
...
export const accountSettingsScreen = {
  ...
  fieldInput: "w-full bg-[#0d1a0f] border border-[#1a2a1c] py-[13px] px-4 text-txt-primary text-sm font-mono mb-4",
  ...
  saveBtn: "w-full py-[15px] bg-baza-green text-black text-[11px] tracking-wide-2xl font-mono font-bold",
...
export const floatingCart = {
  button: "absolute top-[52px] right-4 z-[200] bg-txt-primary py-2 px-3.5 flex-row items-center justify-between",
  iconWrap: "flex-row items-center gap-3",
  cartIcon: "text-lg relative",
  badge: "absolute -top-1.5 -right-2 w-4 h-4 rounded-full bg-baza-green border-2 border-txt-primary items-center justify-center",
...
export const walletScreen = {
  ...
  balanceAmount: "text-[40px] text-txt-primary font-bold font-serif tracking-tight-half mb-1",
  ...
  topUpTransferBtn: "flex-1 py-3 bg-transparent border border-[#2a4a2c] items-center",
  topUpTransferBtnText: "text-baza-green text-xxs tracking-wide-xl font-mono font-bold",
