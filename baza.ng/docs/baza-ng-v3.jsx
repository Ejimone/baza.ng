...
const MEAL_PACKS = [
  {
    ...
    items: [
      { name: "Long grain rice", unit: "cups", perPlate: 0.5, emoji: "🌾", pricePerPlate: 450 },
      { name: "Fresh tomatoes", unit: "pcs", perPlate: 1.5, emoji: "🍅", pricePerPlate: 200 },
      { name: "Tatashe peppers", unit: "pcs", perPlate: 0.5, emoji: "🫑", pricePerPlate: 150 },
      { name: "Scotch bonnet", unit: "pcs", perPlate: 0.25, emoji: "🌶️", pricePerPlate: 80 },
      { name: "Chicken", unit: "pieces", perPlate: 1, emoji: "🍗", pricePerPlate: 950 },
      { name: "Seasoning cube", unit: "cubes", perPlate: 0.5, emoji: "🧂", pricePerPlate: 50 },
      { name: "Vegetable oil", unit: "tbsp", perPlate: 2, emoji: "🫙", pricePerPlate: 120 },
      { name: "Onions", unit: "medium", perPlate: 0.5, emoji: "🧅", pricePerPlate: 75 },
    ]
  },
  {
    ...
    items: [
      { name: "Egusi seeds", unit: "cups", perPlate: 0.5, emoji: "🟡", pricePerPlate: 600 },
      { name: "Pumpkin leaves", unit: "handfuls", perPlate: 1, emoji: "🌿", pricePerPlate: 150 },
      { name: "Beef", unit: "pieces", perPlate: 2, emoji: "🥩", pricePerPlate: 1100 },
      { name: "Stockfish", unit: "pieces", perPlate: 0.5, emoji: "🐟", pricePerPlate: 400 },
      { name: "Palm oil", unit: "tbsp", perPlate: 2, emoji: "🫙", pricePerPlate: 130 },
      { name: "Crayfish", unit: "tbsp", perPlate: 1, emoji: "🦐", pricePerPlate: 200 },
      { name: "Peppers", unit: "pcs", perPlate: 0.75, emoji: "🌶️", pricePerPlate: 100 },
      { name: "Onions", unit: "medium", perPlate: 0.5, emoji: "🧅", pricePerPlate: 120 },
    ]
  },
  {
    ...
    items: [
      { name: "Fresh okro", unit: "pcs", perPlate: 8, emoji: "🫛", pricePerPlate: 700 },
      { name: "Shrimp", unit: "handfuls", perPlate: 1, emoji: "🦐", pricePerPlate: 900 },
      { name: "Beef", unit: "pieces", perPlate: 2, emoji: "🥩", pricePerPlate: 1100 },
      { name: "Palm oil", unit: "tbsp", perPlate: 1.5, emoji: "🫙", pricePerPlate: 130 },
      { name: "Peppers", unit: "pcs", perPlate: 0.5, emoji: "🌶️", pricePerPlate: 80 },
      { name: "Crayfish", unit: "tbsp", perPlate: 0.75, emoji: "🦐", pricePerPlate: 200 },
    ]
  },
  {
    ...
    items: [
      { name: "Parboiled rice", unit: "cups", perPlate: 0.5, emoji: "🌾", pricePerPlate: 430 },
      { name: "Mixed vegetables", unit: "cups", perPlate: 0.5, emoji: "🥦", pricePerPlate: 350 },
      { name: "Chicken liver", unit: "pieces", perPlate: 2, emoji: "🍗", pricePerPlate: 800 },
      { name: "Eggs", unit: "pcs", perPlate: 1, emoji: "🥚", pricePerPlate: 220 },
      { name: "Soy sauce", unit: "tbsp", perPlate: 1, emoji: "🍶", pricePerPlate: 120 },
      { name: "Butter", unit: "tbsp", perPlate: 1, emoji: "🧈", pricePerPlate: 150 },
      { name: "Green onions", unit: "stalks", perPlate: 2, emoji: "🌿", pricePerPlate: 80 },
    ]
  },
];
...
const RESTOCK_ITEMS = [
  ...
  { id: "r13", name: "Semolina 1kg",              brand: "Honeywell",     price: 1800,  emoji: "🟡", category: "Grains" },
  { id: "r14", name: "Semolina 5kg",              brand: "Honeywell",     price: 8500,  emoji: "🟡", category: "Grains" },
  { id: "r15", name: "Wheat Flour 2kg",           brand: "Honeywell",     price: 2100,  emoji: "🌫️", category: "Grains" },
  // Protein
  { id: "r20", name: "Chicken (whole, 1.5kg)",    brand: "Farm Fresh",    price: 4800,  emoji: "🍗", category: "Protein" },
  { id: "r21", name: "Beef 1kg",                  brand: "Local Farm",    price: 5200,  emoji: "🥩", category: "Protein" },
  { id: "r22", name: "Fresh Tilapia 1kg",         brand: "Local Farm",    price: 3600,  emoji: "🐟", category: "Protein" },
  { id: "r23", name: "Titus Mackerel ×6 cans",   brand: "Titus",         price: 4200,  emoji: "🐟", category: "Protein" },
  { id: "r24", name: "Eggs ×30",                  brand: "Farm Fresh",    price: 4500,  emoji: "🥚", category: "Protein" },
  { id: "r25", name: "Eggs ×12",                  brand: "Farm Fresh",    price: 1950,  emoji: "🥚", category: "Protein" },
  { id: "r26", name: "Black-eyed Beans 1kg",      brand: "Local",         price: 2200,  emoji: "🫘", category: "Protein" },
  { id: "r27", name: "Black-eyed Beans 5kg",      brand: "Local",         price: 10500, emoji: "🫘", category: "Protein" },
  // Cooking
  ...
  { id: "r30", name: "Palm Oil 1L",               brand: "Buka Fresh",    price: 2400,  emoji: "🧡", category: "Cooking" },
  { id: "r31", name: "Palm Oil 4L",               brand: "Buka Fresh",    price: 8800,  emoji: "🧡", category: "Cooking" },
  { id: "r32", name: "Tomato Stew (frozen, 1kg)", brand: "Baza Kitchen",  price: 2900,  emoji: "🍅", category: "Cooking" },
  { id: "r33", name: "Crayfish (ground) 100g",    brand: "Local",         price: 1100,  emoji: "🦐", category: "Cooking" },
  // Seasoning
  { id: "r9",  name: "Maggi Cubes ×50",           brand: "Maggi",         price: 950,   emoji: "🧂", category: "Seasoning" },
  { id: "r40", name: "Knorr Chicken ×50",         brand: "Knorr",         price: 1050,  emoji: "🧂", category: "Seasoning" },
  { id: "r41", name: "Cameroon Pepper 100g",      brand: "Local",         price: 750,   emoji: "🌶️", category: "Seasoning" },
  { id: "r42", name: "Curry Powder 100g",         brand: "Doyin",         price: 650,   emoji: "🟡", category: "Seasoning" },
  { id: "r43", name: "Thyme 50g",                 brand: "Doyin",         price: 550,   emoji: "🌿", category: "Seasoning" },
  { id: "r44", name: "Table Salt 1kg",            brand: "Dangote",       price: 550,   emoji: "🧂", category: "Seasoning" },
  // Dairy
  ...
  { id: "r50", name: "Butter 250g",               brand: "Anchor",        price: 2100,  emoji: "🧈", category: "Dairy" },
  { id: "r51", name: "Hollandia Yoghurt 500ml",   brand: "Hollandia",     price: 1400,  emoji: "🥛", category: "Dairy" },
  // Staples
  { id: "r12", name: "Dangote Sugar 2kg",         brand: "Dangote",       price: 3200,  emoji: "🍬", category: "Staples" },
  { id: "r60", name: "Dangote Sugar 5kg",         brand: "Dangote",       price: 7800,  emoji: "🍬", category: "Staples" },
  { id: "r61", name: "Milo 200g",                 brand: "Nestlé",        price: 1900,  emoji: "☕", category: "Staples" },
  { id: "r62", name: "Milo 400g",                 brand: "Nestlé",        price: 3600,  emoji: "☕", category: "Staples" },
  { id: "r63", name: "Lipton Yellow Label ×100",  brand: "Lipton",        price: 1200,  emoji: "🍵", category: "Staples" },
  { id: "r64", name: "Nescafé 50g",               brand: "Nescafé",       price: 2400,  emoji: "☕", category: "Staples" },
  // Household
  { id: "r70", name: "Ariel Washing Powder 1kg",  brand: "Ariel",         price: 2800,  emoji: "🧺", category: "Household" },
  { id: "r71", name: "Omo Detergent 500g",        brand: "Omo",           price: 1400,  emoji: "🧺", category: "Household" },
  { id: "r72", name: "Izal Disinfectant 750ml",   brand: "Izal",          price: 1900,  emoji: "🧴", category: "Household" },
  { id: "r73", name: "Sponge + Scrub ×3",         brand: "Local",         price: 600,   emoji: "🧽", category: "Household" },
  { id: "r74", name: "Toilet Rolls ×12",          brand: "Innoson",       price: 2200,  emoji: "🧻", category: "Household" },
  { id: "r75", name: "Hand Wash Refill 500ml",    brand: "Dettol",        price: 1700,  emoji: "🧴", category: "Household" },
];

const RESTOCK_CATS = ["All", "Grains", "Protein", "Cooking", "Seasoning", "Dairy", "Staples", "Household"];
...
function IntentGate({ onSelect }) {
  const modes = [
    ...
    { key: "quickies", emoji: "⚡", title: "Snacks & Drinks", desc: "Drinks, snacks & baked goods", color: "#c77dff" },
    { key: "restock",  emoji: "🔍", title: "Shop Your List", desc: "Pick exactly what you need", color: "#6ec6ff" },
...
// ── MEAL PACK DETAIL (adjustable plates + per-ingredient toggle & qty) ────────
function MealPackDetail({ pack, onBack, onAdd }) {
  const [plates, setPlates] = useState(pack.basePlates);
  // removed: set of item names the user has toggled off ("I already have this")
  const [removed, setRemoved] = useState(new Set());
  // extraQty: { [name]: multiplier } — 1 = default, 2 = double, etc.
  const [extraQty, setExtraQty] = useState({});

  const toggle = (name) => setRemoved(prev => {
    const next = new Set(prev);
    next.has(name) ? next.delete(name) : next.add(name);
    return next;
  });

  const getMultiplier = (name) => extraQty[name] ?? 1;
  const setMultiplier = (name, val) => setExtraQty(p => ({ ...p, [name]: Math.max(1, Math.min(4, val)) }));

  // Price = sum of included items × pricePerPlate × plates × multiplier
  const price = Math.round(
    pack.items.reduce((total, item) => {
      if (removed.has(item.name)) return total;
      return total + (item.pricePerPlate * plates * getMultiplier(item.name));
    }, 0)
  );
  ...
  return (
    <div style={{ width:"100%",height:"100%",background:pack.bg,display:"flex",flexDirection:"column",fontFamily:"monospace" }}>
      {/* Hero */}
      <div style={{ height:180,display:"flex",alignItems:"center",justifyContent:"center",background:`linear-gradient(135deg,${pack.bg},${pack.color}18)`,position:"relative" }}>
        <div style={{ fontSize:72 }}>{pack.emoji}</div>
        <button onClick={onBack} style={{ position:"absolute",top:52,left:20,background:"rgba(0,0,0,0.5)",border:"1px solid #333",color:"#aaa",fontSize:10,letterSpacing:"0.2em",padding:"7px 14px",cursor:"pointer" }}>← BACK</button>
      </div>

      {/* Info + plates */}
      <div style={{ padding:"16px 22px 0" }}>
        <div style={{ fontSize:9,color:pack.color,letterSpacing:"0.3em",marginBottom:5 }}>{time} MIN COOK TIME</div>
        <div style={{ fontSize:24,color:"#f0f0e8",fontFamily:"'DM Serif Display',serif",letterSpacing:"-1px",marginBottom:5 }}>{pack.name}</div>
        <div style={{ fontSize:11,color:"#5a7a5a",lineHeight:1.6,marginBottom:14 }}>{pack.desc}</div>

        <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 14px",background:`${pack.color}0e`,border:`1px solid ${pack.color}22`,marginBottom:4 }}>
          <div>
            <div style={{ fontSize:10,color:pack.color,letterSpacing:"0.2em",marginBottom:2 }}>PLATES / SERVINGS</div>
            <div style={{ fontSize:9,color:"#3a5a3a" }}>Quantities scale with plates</div>
          </div>
          <QtyControl value={plates} min={1} max={12} onChange={setPlates} color={pack.color} />
        </div>

        {removedCount > 0 && (
          <div style={{ fontSize:9,color:pack.color,letterSpacing:"0.15em",padding:"6px 14px",background:`${pack.color}08`,border:`1px solid ${pack.color}22`,marginBottom:4 }}>
            {removedCount} ITEM{removedCount>1?"S":""} REMOVED · PRICE ADJUSTED
          </div>
        )}
      </div>
      ...
      <div style={{ flex:1,overflowY:"auto",padding:"10px 22px" }}>
        <div style={{ fontSize:8,letterSpacing:"0.25em",color:"#2a3a2a",marginBottom:10 }}>
          TAP × TO REMOVE ITEMS YOU ALREADY HAVE
        </div>
        {pack.items.map((item, i) => {
          const isRemoved = removed.has(item.name);
          const mult = getMultiplier(item.name);
          const scaled = item.perPlate * plates * mult;
          const display = scaled % 1 === 0 ? scaled : scaled.toFixed(1);
          const linePrice = isRemoved ? 0 : item.pricePerPlate * plates * mult;

          return (
            <div key={i} style={{
              display:"flex",alignItems:"center",gap:10,
              padding:"11px 0",
              borderBottom:`1px solid ${pack.color}0a`,
              ...
              <div style={{ flex:1,minWidth:0 }}>
                <div style={{ fontSize:12,color: isRemoved?"#3a4a3a":"#c0d8c0",textDecoration:isRemoved?"line-through":"none",transition:"all 0.2s" }}>
                  {item.name}
                </div>
                <div style={{ fontSize:9,color: isRemoved?"#2a3a2a":pack.color,marginTop:3,fontFamily:"monospace" }}>
                  {display} {item.unit}
                  {!isRemoved && linePrice > 0 && <span style={{ color:"#3a5a3a",marginLeft:8 }}>· {fmt(linePrice)}</span>}
                </div>
              </div>

              {/* Extra qty multiplier — only when included */}
              {!isRemoved && (
                <div style={{ display:"flex",alignItems:"center",border:`1px solid ${pack.color}33`,overflow:"hidden",flexShrink:0 }}>
                  <button onClick={()=>setMultiplier(item.name,mult-1)} style={{ width:24,height:24,background:"transparent",border:"none",color:mult===1?"#2a3a2a":pack.color,fontSize:12,cursor:mult===1?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center" }}>−</button>
                  <span style={{ minWidth:18,textAlign:"center",fontSize:11,color:"#f0f0e8",background:pack.bg,lineHeight:"24px",fontFamily:"monospace" }}>{mult}×</span>
                  <button onClick={()=>setMultiplier(item.name,mult+1)} style={{ width:24,height:24,background:"transparent",border:"none",color:mult===4?"#2a3a2a":pack.color,fontSize:12,cursor:mult===4?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center" }}>+</button>
                </div>
              )}

              {/* Remove / restore toggle */}
              <button onClick={()=>toggle(item.name)} style={{
                width:28,height:28,background:isRemoved?`${pack.color}18`:"#1a0a0a",
                border:`1px solid ${isRemoved?pack.color+"44":"#3a1a1a"}`,
                color:isRemoved?pack.color:"#5a2a2a",
                fontSize:isRemoved?11:14,cursor:"pointer",
                display:"flex",alignItems:"center",justifyContent:"center",
      ...
      {/* Footer */}
      <div style={{ padding:"12px 22px 40px",borderTop:`1px solid ${pack.color}18` }}>
        <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12 }}>
          <div>
            <div style={{ fontSize:9,color:"#2a3a2a",letterSpacing:"0.2em" }}>
              {removedCount>0?`ADJUSTED TOTAL (${pack.items.length-removedCount}/${pack.items.length} items)`:`TOTAL FOR ${plates} PLATE${plates>1?"S":""}`}
            </div>
            <div style={{ fontSize:9,color:"#3a5a3a",marginTop:2,letterSpacing:"0.1em" }}>FREE DELIVERY · MEMBERS</div>
          </div>
          <div>
            {removedCount>0 && <div style={{ fontSize:9,color:"#2a3a2a",textDecoration:"line-through",textAlign:"right" }}>{fmt(Math.round(pack.basePrice*(plates/pack.basePlates)))}</div>}
            <div style={{ fontSize:22,color:"#f0f0e8",fontWeight:700 }}>{fmt(price)}</div>
          </div>
        </div>
        <button
          onClick={()=>onAdd({ ...pack, plates, price, removedItems:[...removed], qty:1, type:"mealpack" })}
          disabled={pack.items.length === removedCount}
          style={{
            width:"100%",padding:"15px 0",
            background:pack.items.length===removedCount?"#1a1a1a":pack.color,
            border:"none",color:"#000",
            fontSize:11,letterSpacing:"0.3em",fontFamily:"monospace",
            cursor:pack.items.length===removedCount?"default":"pointer",fontWeight:700
          }}
        >
          {pack.items.length===removedCount?"NOTHING TO ADD":"ADD TO CART · "+plates+" PLATE"+(plates>1?"S":"")}
        </button>
      </div>
    </div>
  );
...
function ReadyEatMode({ cart, setCart, onBack }) {
  const [popup, setPopup] = useState(null);   // item being previewed
  const [plates, setPlates] = useState(1);    // plates for popup item
  const [itemPlates, setItemPlates] = useState({}); // per-item plates in cart

  const openPopup = (item) => { setPopup(item); setPlates(itemPlates[item.id] || 1); };
  const closePopup = () => setPopup(null);

  const inCart = (id) => cart.some(c => c.id === id);

  const addOrUpdate = (item, qty) => {
    const totalPrice = item.price * qty;
    setItemPlates(p => ({ ...p, [item.id]: qty }));
    setCart(prev => {
      const exists = prev.find(c => c.id === item.id);
      if (exists) return prev.map(c => c.id === item.id ? { ...c, qty, plates: qty, price: totalPrice } : c);
      return [...prev, { ...item, qty, plates: qty, price: totalPrice, type: "readyeat" }];
    });
    closePopup();
  };

  return (
    <div style={{ width:"100%",height:"100%",background:"#0a0600",display:"flex",flexDirection:"column",fontFamily:"monospace",position:"relative" }}>
      ...
      <div style={{ flex:1,overflowY:"auto",padding:"14px 20px 80px",display:"flex",flexDirection:"column",gap:10 }}>
        {READY_EAT.map((item,i)=>(
          <div key={item.id} style={{
            background:item.bg, border:`1px solid ${inCart(item.id)?item.color+"66":item.color+"22"}`,
            padding:"14px 16px", display:"flex", alignItems:"center", gap:14,
            transition:"border-color 0.2s",
            animation:`fadeUp 0.3s ${i*0.06}s both`
          }}>
            {/* Tappable emoji image → popup */}
            <button onClick={()=>openPopup(item)} style={{
              width:56,height:56,background:`${item.color}15`,
              border:`1px solid ${item.color}33`,
              display:"flex",alignItems:"center",justifyContent:"center",
              fontSize:30,cursor:"pointer",flexShrink:0,
              transition:"transform 0.15s"
            }}>{item.emoji}</button>

            <div style={{ flex:1,minWidth:0 }}>
              <div style={{ fontSize:9,color:item.color,letterSpacing:"0.2em",marginBottom:3 }}>{item.kitchen.toUpperCase()}</div>
              <div style={{ fontSize:13,color:"#f0f0e8",fontFamily:"'DM Serif Display',serif",letterSpacing:"-0.3px" }}>{item.name}</div>
              <div style={{ display:"flex",gap:8,marginTop:5,alignItems:"center" }}>
                <span style={{ fontSize:9,color:"#4a3a2a" }}>🕐 {item.time}</span>
                {item.oldPrice && <span style={{ fontSize:9,color:"#3a2a1a",textDecoration:"line-through" }}>{fmt(item.oldPrice)}</span>}
                <span style={{ fontSize:11,color:"#f0f0e8",fontWeight:700 }}>{fmt(item.price)}</span>
              </div>
            </div>

            {/* Right: plates stepper if in cart, else ADD */}
            {!inCart(item.id) ? (
              <button onClick={()=>openPopup(item)} style={{
              ...
              <div style={{ display:"flex",flexDirection:"column",alignItems:"flex-end",gap:4,flexShrink:0 }}>
                <div style={{ display:"flex",alignItems:"center",border:`1px solid ${item.color}44`,overflow:"hidden" }}>
                  <button onClick={()=>addOrUpdate(item,Math.max(1,(itemPlates[item.id]||1)-1))} style={{ width:28,height:28,background:"#1a0600",border:"none",color:item.color,fontSize:14,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center" }}>−</button>
                  <span style={{ minWidth:26,textAlign:"center",fontSize:12,color:"#f0f0e8",background:item.bg,lineHeight:"28px" }}>{itemPlates[item.id]||1}</span>
                  <button onClick={()=>addOrUpdate(item,Math.min(8,(itemPlates[item.id]||1)+1))} style={{ width:28,height:28,background:"#1a0600",border:"none",color:item.color,fontSize:14,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center" }}>+</button>
                </div>
                <div style={{ fontSize:8,color:item.color,letterSpacing:"0.1em" }}>✓ {itemPlates[item.id]||1} PLATE{(itemPlates[item.id]||1)!==1?"S":""}</div>
              </div>
            )}
          </div>
        ))}
      ...
      {popup && (
        <div style={{
          ...
          <div onClick={e=>e.stopPropagation()} style={{
            background:popup.bg,borderTop:`2px solid ${popup.color}44`,
            borderRadius:"20px 20px 0 0",padding:"0 0 44px",
            animation:"slideUp 0.25s ease both"
          }}>
            {/* Big emoji hero */}
            <div style={{
              height:180,display:"flex",alignItems:"center",justifyContent:"center",
              background:`radial-gradient(circle at 50% 60%, ${popup.color}18, transparent 70%)`,
              position:"relative"
            }}>
              <div style={{ fontSize:100,lineHeight:1 }}>{popup.emoji}</div>
              <button onClick={closePopup} style={{
                position:"absolute",top:16,right:20,
                background:"rgba(0,0,0,0.5)",border:"none",color:"#888",
                fontSize:18,cursor:"pointer",width:32,height:32,
                borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center"
              }}>×</button>
              <div style={{ position:"absolute",top:16,left:20,background:`${popup.color}22`,border:`1px solid ${popup.color}44`,padding:"5px 10px" }}>
                <span style={{ fontSize:9,color:popup.color,letterSpacing:"0.15em" }}>🕐 {popup.time}</span>
              </div>
            </div>

            <div style={{ padding:"16px 22px 20px" }}>
              <div style={{ fontSize:9,color:popup.color,letterSpacing:"0.3em",marginBottom:4 }}>{popup.kitchen.toUpperCase()}</div>
              <div style={{ fontSize:22,color:"#f0f0e8",fontFamily:"'DM Serif Display',serif",letterSpacing:"-0.8px",marginBottom:6 }}>{popup.name}</div>
              <div style={{ fontSize:11,color:"#6a5a4a",lineHeight:1.7,marginBottom:12 }}>{popup.desc}</div>
              <div style={{ display:"flex",gap:6,flexWrap:"wrap",marginBottom:18 }}>
                {popup.tags.map(t=>(
                  <span key={t} style={{ fontSize:8,color:popup.color,border:`1px solid ${popup.color}33`,padding:"3px 8px",letterSpacing:"0.1em" }}>{t}</span>
                ))}
              </div>

              {/* Plates adjuster */}
              <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:18,padding:"12px 16px",background:"#ffffff0a",border:`1px solid ${popup.color}22` }}>
                <div>
                  <div style={{ fontSize:9,color:"#4a3a2a",letterSpacing:"0.2em",marginBottom:3 }}>PLATES</div>
                  <div style={{ fontSize:11,color:"#8a6a4a",letterSpacing:"0.1em" }}>{fmt(popup.price)} each</div>
                </div>
                <div style={{ display:"flex",alignItems:"center",gap:0,border:`1px solid ${popup.color}44`,overflow:"hidden" }}>
                  <button onClick={()=>setPlates(p=>Math.max(1,p-1))} style={{ width:36,height:36,background:plates===1?"#2a0600":"#1a0800",border:"none",color:plates===1?"#6a3a2a":popup.color,fontSize:18,cursor:"pointer" }}>−</button>
                  <span style={{ minWidth:40,textAlign:"center",fontSize:16,color:"#f0f0e8",background:popup.bg,lineHeight:"36px",fontFamily:"monospace" }}>{plates}</span>
                  <button onClick={()=>setPlates(p=>Math.min(8,p+1))} style={{ width:36,height:36,background:"#1a0800",border:"none",color:popup.color,fontSize:18,cursor:"pointer" }}>+</button>
                </div>
              </div>

              <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14 }}>
                {popup.oldPrice && <div style={{ fontSize:10,color:"#3a2a1a",textDecoration:"line-through" }}>{fmt(popup.oldPrice*plates)}</div>}
                <div style={{ fontSize:22,color:"#f0f0e8",fontWeight:700,fontFamily:"monospace" }}>{fmt(popup.price*plates)}</div>
                <div style={{ fontSize:9,color:"#3a5c3a",letterSpacing:"0.12em" }}>FREE DELIVERY · MEMBERS</div>
              </div>

              <button onClick={()=>addOrUpdate(popup,plates)} style={{
                width:"100%",padding:"15px",background:popup.color,
                border:"none",color:"#000",
                fontSize:11,letterSpacing:"0.3em",fontFamily:"monospace",cursor:"pointer",fontWeight:700
              }}>ADD {plates} PLATE{plates!==1?"S":""} · {fmt(popup.price*plates)}</button>
            </div>
          </div>
        </div>
      )}
...
// ── QUICKIES MODE ─────────────────────────────────────────────────────────────
function SnacksDrinksMode({ cart, setCart, onBack }) {
  ...
  return (
    <div style={{ width:"100%",height:"100%",background:"#0c0714",display:"flex",flexDirection:"column",fontFamily:"monospace" }}>
      <div style={{ padding:"52px 24px 16px" }}>
        ...
        <div style={{ fontSize:26,color:"#f0f0e8",fontFamily:"'DM Serif Display',serif",letterSpacing:"-1px" }}>Snacks & Drinks</div>
        <div style={{ fontSize:9,color:"#3a1a5a",letterSpacing:"0.2em",marginTop:4 }}>SNACKS · DRINKS · BAKED GOODS</div>
      </div>
...
function RestockMode({ cart, setCart, onBack }) {
  ...
  const filtered = RESTOCK_ITEMS.filter(i => {
  ...
  return (
    <div style={{ width: "100%", height: "100%", background: "#070a12", display: "flex", flexDirection: "column", fontFamily: "monospace" }}>
      <div style={{ padding: "52px 20px 14px" }}>
        ...
        <div style={{ fontSize: 26, color: "#f0f0e8", fontFamily: "'DM Serif Display', serif", letterSpacing: "-1px", marginBottom: 14 }}>Shop Your List</div>
        ...
        <div style={{ fontSize: 9, color: "#1a2a3a", letterSpacing: "0.15em", marginTop: 8, marginBottom: 2 }}>
          SEARCH OR BROWSE BY CATEGORY
        </div>
      </div>

      {/* Category filter */}
      <div style={{ display: "flex", gap: 8, padding: "0 20px 10px", overflowX: "auto", scrollbarWidth: "none" }}>
        {RESTOCK_CATS.map(cat => (
          <button key={cat} onClick={() => { setActiveCat(cat); setQuery(""); }} style={{
            whiteSpace: "nowrap", padding: "6px 14px",
            background: activeCat === cat ? "#6ec6ff18" : "transparent",
            border: activeCat === cat ? "1px solid #6ec6ff55" : "1px solid #1a2540",
            color: activeCat === cat ? "#6ec6ff" : "#3a5a8a",
            fontSize: 9, letterSpacing: "0.2em", cursor: "pointer",
            fontFamily: "monospace", transition: "all 0.15s", flexShrink: 0
          }}>{cat.toUpperCase()}</button>
        ))}
      </div>
...
// ── PROFILE & WALLET ──────────────────────────────────────────────────────────
function ProfileScreen({ balance, setBalance, accountNumber, orders, onBack, onGoOrders, onGoNotifications, onGoAddress, onGoRefer, onGoSupport, onGoAccountSettings, onSignOut }) {
  ...
  return (
    <div style={{ width: "100%", height: "100%", background: "#060c07", display: "flex", flexDirection: "column", fontFamily: "monospace", position: "relative" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "0 24px 40px" }}>
        ...
        {/* Account settings */}
        <div style={{ fontSize:9,color:"#1a2a1a",letterSpacing:"0.25em",marginTop:8,marginBottom:10,paddingTop:16,borderTop:"1px solid #0f1a10" }}>ACCOUNT SETTINGS</div>
        {[
          { icon: "🔑", label: "Change Password", sub: "Update your login password" },
          { icon: "📧", label: "Email Address", sub: "thrive@example.com" },
          { icon: "📱", label: "Phone Number", sub: "+234 800 000 0000" },
        ].map(row => (
          <button key={row.label} onClick={() => onGoAccountSettings(row.label)} style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div style={{ textAlign: "left" }}>
                <div style={{ fontSize: 12, color: "#d0e0d0", fontFamily: "monospace" }}>{row.label}</div>
                <div style={{ fontSize: 9, color: "#2a4a2a", marginTop: 3, letterSpacing: "0.1em" }}>{row.sub}</div>
              </div>
            </div>
            <span style={{ color: "#2a4a2a", fontSize: 18 }}>›</span>
          </button>
...
function AccountSettingsScreen({ type, onBack }) {
  const [saved, setSaved] = useState(false);
  const [vals, setVals] = useState({ current:"", newVal:"", confirm:"", email:"thrive@example.com", phone:"+234 800 000 0000" });
  const set = (k,v) => setVals(p=>({...p,[k]:v}));

  const handleSave = () => { setSaved(true); setTimeout(()=>setSaved(false),2500); };

  const isPassword = type === "Change Password";
  const isEmail = type === "Email Address";
  const isPhone = type === "Phone Number";

  return (
    <div style={{ width:"100%",height:"100%",background:"#060d07",display:"flex",flexDirection:"column",fontFamily:"monospace" }}>
      <div style={{ padding:"52px 24px 24px",borderBottom:"1px solid #0f1a10" }}>
        <button onClick={onBack} style={{ background:"none",border:"none",color:"#3a5c3a",fontSize:11,cursor:"pointer",letterSpacing:"0.2em",marginBottom:14,padding:0 }}>← PROFILE</button>
        <div style={{ fontSize:9,color:"#2a4a2a",letterSpacing:"0.3em",marginBottom:6 }}>ACCOUNT SETTINGS</div>
        <div style={{ fontSize:24,color:"#f0f0e8",fontFamily:"'DM Serif Display',serif",letterSpacing:"-0.8px" }}>{type}</div>
      </div>
      ...
      <div style={{ flex:1,padding:"24px 24px 40px" }}>
        {isPassword && (
          <>
            {[
              { label:"CURRENT PASSWORD", key:"current", type:"password", ph:"············" },
              { label:"NEW PASSWORD", key:"newVal", type:"password", ph:"············" },
              { label:"CONFIRM NEW PASSWORD", key:"confirm", type:"password", ph:"············" },
            ].map(f=>(
              <div key={f.key} style={{ marginBottom:16 }}>
                <div style={{ fontSize:8,color:"#2a4a2a",letterSpacing:"0.25em",marginBottom:8 }}>{f.label}</div>
                <input type={f.type} value={vals[f.key]} onChange={e=>set(f.key,e.target.value)} placeholder={f.ph}
                  style={{ width:"100%",background:"#0d1a0f",border:"1px solid #1a2a1c",padding:"13px 16px",color:"#f0f0e8",fontSize:14,fontFamily:"monospace",outline:"none" }}
                />
              </div>
            ))}
            {vals.newVal && vals.confirm && vals.newVal !== vals.confirm && (
              <div style={{ fontSize:9,color:"#e85c3a",letterSpacing:"0.1em",marginBottom:12 }}>Passwords don't match.</div>
            )}
            <div style={{ fontSize:9,color:"#1a2a1a",lineHeight:1.8,marginBottom:24,letterSpacing:"0.1em" }}>
              Use at least 8 characters.<br/>Mix letters, numbers, and symbols.
            </div>
          </>
        )}
        ...
        {isEmail && (
          <div style={{ marginBottom:24 }}>
            <div style={{ fontSize:8,color:"#2a4a2a",letterSpacing:"0.25em",marginBottom:8 }}>EMAIL ADDRESS</div>
            <input type="email" value={vals.email} onChange={e=>set("email",e.target.value)}
              style={{ width:"100%",background:"#0d1a0f",border:"1px solid #1a2a1c",padding:"13px 16px",color:"#f0f0e8",fontSize:14,fontFamily:"monospace",outline:"none",marginBottom:8 }}
            />
            <div style={{ fontSize:9,color:"#1a2a1a",lineHeight:1.8,letterSpacing:"0.1em" }}>
              Used for receipts and account recovery.<br/>A verification link will be sent.
            </div>
          </div>
        )}
        ...
        {isPhone && (
          <div style={{ marginBottom:24 }}>
            <div style={{ fontSize:8,color:"#2a4a2a",letterSpacing:"0.25em",marginBottom:8 }}>PHONE NUMBER</div>
            <input type="tel" value={vals.phone} onChange={e=>set("phone",e.target.value)}
              style={{ width:"100%",background:"#0d1a0f",border:"1px solid #1a2a1c",padding:"13px 16px",color:"#f0f0e8",fontSize:14,fontFamily:"monospace",outline:"none",marginBottom:8 }}
            />
            <div style={{ fontSize:9,color:"#1a2a1a",lineHeight:1.8,letterSpacing:"0.1em" }}>
              We'll send an OTP to verify the new number.
            </div>
          </div>
        )}

        <button onClick={handleSave} style={{
          width:"100%",padding:"15px",background:"#4caf7d",border:"none",
          color:"#000",fontSize:11,letterSpacing:"0.3em",
          fontFamily:"monospace",cursor:"pointer",fontWeight:700,
          transition:"all 0.2s"
        }}>{saved ? "✓ SAVED" : "SAVE CHANGES"}</button>

        {saved && (
          <div style={{ marginTop:14,fontSize:9,color:"#4caf7d",textAlign:"center",letterSpacing:"0.2em",animation:"fadeUp 0.2s ease" }}>
            {isPassword?"Password updated successfully.":isEmail?"Verification email sent.":"OTP sent to new number."}
          </div>
        )}
      </div>
...
export default function BazaApp() {
  ...
  const [acctSettingsType, setAcctSettingsType] = useState(null);
    ...
    <div style={{ minHeight: "100vh", background: "#030503", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{
        ...
        <div style={{ position: "absolute", inset: 0 }}>
          ...
          {screen === "quickies" && <SnacksDrinksMode  cart={cart} setCart={setCart} onBack={() => setScreen("intent")} />}
          ...
          {screen === "profile" && (
            <ProfileScreen
              ...
              onGoAccountSettings={(type) => { setAcctSettingsType(type); setScreen("acctsettings"); }}
          ...
          {screen === "acctsettings" && <AccountSettingsScreen type={acctSettingsType} onBack={() => setScreen("profile")} />}
    ...
    <div style={{ width: "100%", height: "100%", background: "#080f09", display: "flex", flexDirection: "column", fontFamily: "monospace", position: "relative" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: `0 20px ${bottomPad}px` }}>
        ...
        {hasOrders && (
          <button onClick={onGoOrders} style={{
            width: "100%",
            background: "linear-gradient(135deg, #1a1000 0%, #1a0e00 100%)",
            border: "1px solid #f5a62355",
            padding: "14px 16px", display: "flex", alignItems: "center", gap: 14,
            cursor: "pointer", textAlign: "left", marginBottom: 12,
            animation: "fadeUp 0.3s ease both",
            boxShadow: "0 0 20px #f5a62310"
          }}>
            <div style={{
              width: 36, height: 36, borderRadius: "50%",
              background: "#f5a62320", border: "1px solid #f5a62344",
              display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, flexShrink: 0
            }}>📦</div>
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 9, color: "#f5a623", letterSpacing: "0.25em", marginBottom: 4 }}>
                ● ACTIVE ORDER{orders.length !== 1 ? "S" : ""}
              </div>
              <div style={{ fontSize: 13, color: "#f0f0e8", fontFamily: "'DM Serif Display', serif", letterSpacing: "-0.3px" }}>
                {orders[0]?.items?.slice(0,2).map(i=>i.name).join(", ") || "Your order"}
              </div>
              <div style={{ fontSize: 9, color: "#8a6030", marginTop: 3, letterSpacing: "0.1em" }}>
                {orders[0]?.eta || "Tomorrow by 10am"}
              </div>
            </div>
            <div style={{ textAlign: "right", flexShrink: 0 }}>
              <div style={{ fontSize: 9, color: "#f5a623", letterSpacing: "0.15em", marginBottom: 4 }}>
                {orders[0]?.status?.toUpperCase()}
              </div>
              <div style={{ fontSize: 9, color: "#7a5020", letterSpacing: "0.15em" }}>VIEW ›</div>
            </div>
          </button>
        )}
